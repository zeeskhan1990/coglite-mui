...
export default class FileProxy {
  ...
  public getComputeNodeFileProperties(
    ...
    return new Promise((resolve, reject) => {
      this.client.file.getPropertiesFromComputeNode(
        poolId,
        nodeId,
        filename,
        wrapOptions(options),
  ...
  public getTaskFileProperties(
    ...
    return new Promise((resolve, reject) => {
      this.client.file.getPropertiesFromTask(
        jobId,
        taskId,
        filename,
        wrapOptions(options),
