...
export default class NodeProxy {
  ...
  public list(poolId: string, options?: models.ComputeNodeListOptions) {
    return new ListProxy(
      this.client.computeNodeOperations,
      [poolId],
  ...
  public updateUser(
    ...
    return this.client.computeNodeOperations.updateUser(
      poolId,
      nodeId,
      username,
      user,
  ...
  public deleteUser(poolId: string, nodeId: string, userName: string, options?: any): Promise<any> {
    return this.client.computeNodeOperations.deleteUser(
      poolId,
      nodeId,
      userName,
      wrapOptions(options),
  ...
  public getRemoteLoginSettings(poolId: string, nodeId: string, options?: any): Promise<any> {
    return mapGet(
      this.client.computeNodeOperations.getRemoteLoginSettings(
        poolId,
        nodeId,
        wrapOptions(options),
      ),
